...
<div id="dropzone" class="dropzone" 
     ...
     ondrop="drop(event,'<?php echo $unique_id; ?>')">
    <p>
...
<p class="folderInfo"><?php echo $imagebrowser2; ?> <span id="finalcount"></span> <?php echo $imagebrowser3; ?> - <span id="finalsize"></span>
    <?php if($file_style == "block") { ?>
        <img title="List" src="img/cd-icon-list.png" class="headerIcon floatRight" onclick="window.location.href = 'pluginconfig.php?file_style=list&unique_id=<?php echo $unique_id; ?>';">
    <?php } elseif($file_style == "list") { ?>
        <img title="Block" src="img/cd-icon-block.png" class="headerIcon floatRight" onclick="window.location.href = 'pluginconfig.php?file_style=block&unique_id=<?php echo $unique_id; ?>';">
...
<div id="uploadImgDiv" class="lightbox popout">
    ...
    <form action="imgupload.php?image_path=<?php echo $unique_id; ?>" method="post" enctype="multipart/form-data" id="uploadImgForm" onsubmit="return checkUpload();">
        <input type="hidden" name="image_path" value="<?php echo $unique_id; ?>">
