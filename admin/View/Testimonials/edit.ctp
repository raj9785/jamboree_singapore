<?php echo $this->Html->script('add_testimonial', array('inline' => false)); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">                                    
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($users_data['Testimonial']['icon_image']) && file_exists(WEBSITE_ADMIN_WEBROOT_ROOT_PATH . '/webroot/uploads/testimonials/icon_image/' . $users_data['Testimonial']['icon_image'])) { ?>
                                            <?php echo $this->Html->image(WEBSITE_URL . '/admin/webroot/uploads/testimonials/icon_image/' . $users_data['Testimonial']['icon_image'], array('border' => 0)); ?>
                                        <?php } else { ?>
