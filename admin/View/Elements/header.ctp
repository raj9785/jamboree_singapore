<header class="navbar navbar-default navbar-static-top">
    ...
    <div class="navbar-header">
        ...
        <span id="site_logo" class="show_me" style="font-size:25px;padding:0px 20px;">
            <?php echo $this->Html->link($this->Html->image('logo.png', array('border' => 0,'width'=>'200px')), array('plugin' => false, 'controller' => 'users', 'action' => 'dashboard'), array('escape' => false)); ?>
        </span>
