...
<form method="post" class="form-horizontal">
    <div class="pull-left grytxt12 pr10 pt5 paginginfo " style="padding-top: 5px;"><?php echo $paginator->counter(array('format' => 'Page %page% of&nbsp;&nbsp;%pages%, Total records %count% | ')); ?>Views&nbsp;&nbsp;</div>
    <div class="pull-left">
