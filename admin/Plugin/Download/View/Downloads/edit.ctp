            ...
            <div class="wrap-content container" id="container">
                ...
                <div class="container-fluid container-fullw bg-white">
                    ...
                    <div class="row">
                        ...
                        ?>
                        <?php echo $this->Form->input('Download.id', array('type' => 'hidden')); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12"> 
                                <div class="col-md-6"> 
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->select('download_category_id', $dcat_list, array('id' => 'download_category_id', 'disabled' => true, "class" => "form-control", 'empty' => "Select",)); ?>
                            ...
                            <?php
                            if ($users_data["Download"]['download_category_id'] == 1) {
                                ?>   
                            ...
                            <?php } else {
                                ...
                                <div class="col-md-12" > 
                                    <div class="col-md-6"> 
                                        <div class="form-group">
                                            <label class="control-label">Downloaded File </label>
                                            <a class="btn btn-default" target="_blank" href="<?php echo DOCS_HTTP_PATH.$users_data['Download']['image']; ?>">Download</a>
                                        </div>
                                    </div>
                                </div>
