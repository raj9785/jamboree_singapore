...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#add_new_user").click(function () {
            window.location.href = '<?php echo $this->Html->url(array('plugin' => 'career_category', 'controller' => 'career_categories', 'action' => 'add')); ?>';
        });


        $('#CareerCategoryFromDate').datepicker({
            dateFormat: "yy-mm-dd",
            changeMonth: true,
            changeYear: true,

            onSelect: function (selectedDate) {
                $('#CareerCategoryToDate').datepicker("option", {
                    minDate: new Date(selectedDate),

                });
            },
        });
        $('#CareerCategoryToDate').datepicker({
            dateFormat: "yy-mm-dd",
            //dateFormat: "dd-mm-yy",
            changeMonth: true,
            changeYear: true,
            ...
            onClose: function (selectedDate) {
                $("#CareerCategoryFromDate").datepicker("option", "maxDate", selectedDate);
            }
        ...
        $(".my_status").on('click', function () {
            ...
            if (status_current == 1) {
                var heading = "Career Category will be inactivated";
                var title_resp = "Inactivated";
            } else {
                var heading = "Career Category will be activated";
            ...
            swal({
                ...
                closeOnConfirm: false,
                    ...
                    function () {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo $this->Html->url(array('plugin' => 'career_category', 'controller' => 'career_categories', 'action' => 'status_ajax')); ?>',
                            data: 'id=' + status_id,
                            dataType: 'json',
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 text-align-right">
                            <button class="btn btn-green add-row" id='add_new_user'>
                                <i class="fa fa-plus"></i>&nbsp;Add New Career Category
                            </button>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 space20">
                            <div class="pull-left1 driver_index1">
                                ...
                                <?php
                                //echo $this->Form->select('CareerCategory.category_id', $cat_list, array('value' => @$category_id, 'class' => 'textbox form-control input-sm', 'empty' => "Select Share Type", 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('CareerCategory.name', array('placeholder' => 'Name', 'value' => @$name, 'class' => 'form-control input-sm')) . "&nbsp;&nbsp;";
                                echo $this->Form->select('CareerCategory.is_active', array("1" => "Active", "0" => "Inactive"), array('value' => @$is_active,'empty' => __('Select Status', true), 'class' => 'form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('CareerCategory.from_date', array('placeholder' => __('From Date', true), 'value' => @$from_date,'autocomplete'=>'off', 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('CareerCategory.to_date', array('placeholder' => __('To Date', true), 'value' => @$to_date,'autocomplete'=>'off',  'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown" style='float:left'>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                            ...
                                                            <li>
                                                                <?php
                                                                echo $this->Html->link('Edit', array('plugin' => 'career_category', 'controller' => 'career_categories', 'action' => 'edit', '?' => array('id' => $list['CareerCategory']['id'])), array('class' => '', 'tooltip-placement' => 'top', 'tooltip' => 'Edit', 'escape' => false));
                                                                ?>							
                                                            </li>
