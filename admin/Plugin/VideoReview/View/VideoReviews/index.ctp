...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#add_new_user").click(function () {
            window.location.href = '<?php echo $this->Html->url(array('plugin' => 'video_review', 'controller' => 'video_reviews', 'action' => 'add')); ?>';
        });


        $('#VideoReviewFromDate').datepicker({
            dateFormat: "yy-mm-dd",
            changeMonth: true,
            changeYear: true,

            onSelect: function (selectedDate) {
                $('#VideoReviewToDate').datepicker("option", {
                    minDate: new Date(selectedDate),

                });
            },
        });
        $('#VideoReviewToDate').datepicker({
            dateFormat: "yy-mm-dd",
            //dateFormat: "dd-mm-yy",
            changeMonth: true,
            changeYear: true,
            ...
            onClose: function (selectedDate) {
                $("#VideoReviewFromDate").datepicker("option", "maxDate", selectedDate);
            }
            ...
            swal({
                ...
                closeOnConfirm: false,
                    ...
                    function () {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo $this->Html->url(array('plugin' => 'video_review', 'controller' => 'video_reviews', 'action' => 'status_ajax')); ?>',
                            data: 'id=' + status_id,
                            dataType: 'json',
                    ...
                    <div class="row">
                        <div class="col-md-12 space20">
                            <div class="pull-left1 driver_index1">
                                ...
                                <?php
                                echo $this->Form->select('VideoReview.course_id', $cat_list, array('value' => @$course_id, 'class' => 'textbox form-control input-sm', 'empty' => "Select Course", 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->select('VideoReview.is_active', array("1" => "Active", "0" => "Inactive"), array('value' => @$is_active, 'empty' => __('Select Status', true), 'class' => 'form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('VideoReview.from_date', array('placeholder' => __('From Date', true), 'value' => @$from_date, 'autocomplete' => 'off', 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('VideoReview.to_date', array('placeholder' => __('To Date', true), 'value' => @$to_date, 'autocomplete' => 'off', 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown" style='float:left'>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                            ...
                                                            <li>
                                                                <?php
                                                                echo $this->Html->link('Edit', array('plugin' => 'video_review', 'controller' => 'video_reviews', 'action' => 'edit', '?' => array('id' => $list['VideoReview']['id'])), array('class' => '', 'tooltip-placement' => 'top', 'tooltip' => 'Edit', 'escape' => false));
                                                                ?>							
                                                            </li>
