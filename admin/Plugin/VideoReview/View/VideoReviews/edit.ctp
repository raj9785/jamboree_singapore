...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#cancel_button").click(function () {
            window.location.href = '<?php echo $this->Html->url(array('plugin' => 'video_review', 'controller' => 'video_reviews', 'action' => 'index')); ?>';
        });
...
<?php
echo $this->Html->script(array('video_reviews'));
?>
<div id="app">
    <!-- sidebar -->
            ...
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        ...
                        <div class="col-sm-2 text-align-right">
                            <?php echo $this->Html->link("<i class=\"icon-arrow-left icon-white\"></i>" . __('Back to List', true) . "", array('plugin' => 'video_review', 'controller' => 'video_reviews', "action" => "index"), array("class" => "btn btn-green add-row", "escape" => false)); ?>
                        </div>
                ...
                <div class="container-fluid container-fullw bg-white">
                    ...
                    <div class="row">
                        ...
                        <?php
                        echo $this->Form->create('VideoReview', array(array('method' => 'post', 'class' => 'form', 'role' => 'form'), 'enctype' => 'multipart/form-data'));
                        ?>
                        <?php echo $this->Form->input('VideoReview.id', array('type' => 'hidden')); ?>
                        <div class="row">
                            <div class="col-md-12"> 
                                <div class="col-md-6"> 
