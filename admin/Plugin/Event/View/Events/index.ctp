...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#add_new_user").click(function () {
            window.location.href = '<?php echo $this->Html->url(array('plugin' => 'event', 'controller' => 'events', 'action' => 'add')); ?>';
        });
...
//            closeClick: false,
        ...
        $('#EventFromDate').datepicker({
            ...
            onSelect: function (selectedDate) {
                $('#EventToDate').datepicker("option", {
                    minDate: new Date(selectedDate),

                });

                //$("#EventToDate").datepicker("option", "minDate", selectedDate);
            },
        });
        $('#EventToDate').datepicker({
            ...
            onClose: function (selectedDate) {
                $("#EventFromDate").datepicker("option", "maxDate", selectedDate);
            }
        ...
        $(".my_status").on('click', function () {
            ...
            if (status_current == 1) {
                var heading = "Event will be inactivated";
                var title_resp = "Inactivated";
            } else {
                var heading = "Event will be activated";
            ...
            swal({
                ...
                closeOnConfirm: false,
                    ...
                    function () {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo $this->Html->url(array('plugin' => 'event', 'controller' => 'events', 'action' => 'status_ajax')); ?>',
                            data: 'id=' + status_id,
                            dataType: 'json',
                    ...
                    <div class="row">
                        <div class="col-md-12 space20">
                            <div class="pull-left1 driver_index1">
                                ...
                                <?php
                                //echo $this->Form->select('Event.category_id', $cat_list, array('value' => @$category_id, 'class' => 'textbox form-control input-sm', 'empty' => "Select Share Type", 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Event.title', array('placeholder' => 'Event Title', 'value' => @$title, 'class' => 'form-control input-sm')) . "&nbsp;&nbsp;";
                                echo $this->Form->select('Event.is_active', array("1" => "Active", "0" => "Inactive"), array('value' => @$is_active, 'empty' => __('Select Status', true), 'class' => 'form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Event.from_date', array('placeholder' => __('From Date', true), 'value' => isset($from_date) ? $from_date : '', 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Event.to_date', array('placeholder' => __('To Date', true), 'value' => isset($to_date) ? $to_date : '', 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                    ...
                                    if (!empty($records)) {
                                        ...
                                        <?php foreach ($records as $list) { ?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    echo $list['Event']['title'];
                                                    ?>
                                                </td>
                                                <td><?php
                                                    echo $list['Event']['location'];
                                                    ?>
                                                </td>

                                                <td><?php echo date("d-m-y", strtotime($list[$model]['event_sdate'])); ?></td>
                                                <td><?php echo date("h:i A", strtotime($list[$model]['event_sdate'])); ?></td>
                                                <td><?php echo date("h:i A", strtotime($list[$model]['event_edate'])); ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown" style='float:left'>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                            ...
                                                            <li>
                                                                <?php
                                                                echo $this->Html->link('Edit', array('plugin' => 'event', 'controller' => 'events', 'action' => 'edit', '?' => array('id' => $list['Event']['id'])), array('class' => '', 'tooltip-placement' => 'top', 'tooltip' => 'Edit', 'escape' => false));
                                                                ?>							
                                                            </li>
