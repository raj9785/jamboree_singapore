    ...
    jQuery(document).ready(function () {
        ...
        $('#AdmissionCounsellingResultFromDate').datepicker({
            ...
            onSelect: function (selectedDate) {
                $('#AdmissionCounsellingResultToDate').datepicker("option", {
                    minDate: new Date(selectedDate),

                });
            },
        });
        $('#AdmissionCounsellingResultToDate').datepicker({
            dateFormat: "yy-mm-dd",
            //dateFormat: "dd-mm-yy",
            changeMonth: true,
            changeYear: true,
            ...
            onClose: function (selectedDate) {
                $("#AdmissionCounsellingResultFromDate").datepicker("option", "maxDate", selectedDate);
            }
        ...
        $(".my_status").on('click', function () {
            ...
            if (status_current == 1) {
                var heading = "Counselling Result will be inactivated";
                var title_resp = "Inactivated";
            } else {
                var heading = "Counselling Result will be activated";
            ...
            swal({
                ...
                closeOnConfirm: false,
                    ...
                    function () {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo $this->Html->url(array('plugin' => 'admission_counselling_result', 'controller' => 'admission_counselling_results', 'action' => 'status_ajax')); ?>',
                            data: 'id=' + status_id,
                            dataType: 'json',
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 text-align-right">
                            <button class="btn btn-green add-row" id='add_new_user'>
                                <i class="fa fa-plus"></i>&nbsp;Add New Counselling Result
                            </button>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 space20">
                            <div class="pull-left1 driver_index1">
                                ...
                                <?php
                                echo $this->Form->select('AdmissionCounsellingResult.admission_counselling_course_id', $cat_list, array('value' => @$admission_counselling_course_id, 'class' => 'textbox form-control input-sm', 'empty' => "Select Course", 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('AdmissionCounsellingResult.student_name', array('placeholder' => 'Student Name', 'value' => @$student_name, 'class' => 'form-control input-sm')) . "&nbsp;&nbsp;";
                                echo $this->Form->select('AdmissionCounsellingResult.is_active', array("1" => "Active", "0" => "Inactive"), array('value' => @$is_active, 'empty' => __('Select Status', true), 'class' => 'form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('AdmissionCounsellingResult.from_date', array('placeholder' => __('From Date', true), 'value' => @$from_date, 'autocomplete' => 'off', 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('AdmissionCounsellingResult.to_date', array('placeholder' => __('To Date', true), 'value' => @$to_date, 'autocomplete' => 'off', 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                    ...
                                    if (!empty($records)) {
                                        ...
                                        <?php foreach ($records as $list) { ?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    echo $list['AdmissionCounsellingCourse']['name'];
                                                    ?>
                                                </td>
                                                <td><?php
                                                    echo $list[$model]['university_name'];
                                                    ?>
                                                </td>
                                                <td><?php
                                                    echo $list[$model]['result_year'];
                                                    ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown" style='float:left'>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                            ...
                                                            <li>
                                                                <?php
                                                                echo $this->Html->link('Edit', array('plugin' => 'admission_counselling_result', 'controller' => 'admission_counselling_results', 'action' => 'edit', '?' => array('id' => $list['AdmissionCounsellingResult']['id'])), array('class' => '', 'tooltip-placement' => 'top', 'tooltip' => 'Edit', 'escape' => false));
                                                                ?>							
                                                            </li>
