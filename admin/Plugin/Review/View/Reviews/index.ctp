...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#add_new_user").click(function () {
            window.location.href = '<?php echo $this->Html->url(array('plugin' => 'review', 'controller' => 'reviews', 'action' => 'add')); ?>';
        });
        $("#single_1").fancybox({
            helpers: {
                title: {
        ...
        $('#ReviewFromDate').datepicker({
            ...
            onSelect: function (selectedDate) {
                $('#ReviewToDate').datepicker("option", {
                    minDate: new Date(selectedDate),

                });

                //$("#ReviewToDate").datepicker("option", "minDate", selectedDate);
            },
        });
        $('#ReviewToDate').datepicker({
            ...
            onClose: function (selectedDate) {
                $("#ReviewFromDate").datepicker("option", "maxDate", selectedDate);
            }
            ...
            swal({
                ...
                closeOnConfirm: false,
                    ...
                    function () {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo $this->Html->url(array('plugin' => 'review', 'controller' => 'reviews', 'action' => 'status_ajax')); ?>',
                            data: 'id=' + status_id,
                            dataType: 'json',
                    ...
                    <div class="row">
                        <div class="col-md-12 space20">
                            <div class="pull-left1 driver_index1">
                                ...
                                <?php
                                echo $this->Form->select('Review.course_id', $cat_list, array('value' => @$course_id, 'class' => 'textbox form-control input-sm', 'empty' => "Select Course", 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Review.student_name', array('placeholder' => 'Student Name', 'value' => @$student_name, 'class' => 'form-control input-sm')) . "&nbsp;&nbsp;";
                                echo $this->Form->select('Review.is_active', array("1" => "Active", "0" => "Inactive"), array('value' => @$is_active, 'empty' => __('Review Status', true), 'class' => 'form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Review.from_date', array('placeholder' => __('From Date', true), 'autocomplete' => 'off', 'value' => @$from_date, 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Review.to_date', array('placeholder' => __('To Date', true), 'autocomplete' => 'off', 'value' => @$to_date, 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                        ...
                                        <?php foreach ($records as $list) { ?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    ...
                                                    $images = $this->Html->image(REVIEWS_IMAGE_HTTP_PATH . $file_name, array('width' => "75px", 'height' => '75px'));
                                                    ?>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown" style='float:left'>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                            ...
                                                            <li>
                                                                <?php
                                                                echo $this->Html->link('Edit', array('plugin' => 'review', 'controller' => 'reviews', 'action' => 'edit', '?' => array('id' => $list['Review']['id'])), array('class' => '', 'tooltip-placement' => 'top', 'tooltip' => 'Edit', 'escape' => false));
                                                                ?>							
                                                            </li>
