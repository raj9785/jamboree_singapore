...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#add_new_user").click(function () {
            window.location.href = '<?php echo $this->Html->url(array('plugin' => 'media', 'controller' => 'medias', 'action' => 'add')); ?>';
        });
        $("#single_1").fancybox({
            helpers: {
                title: {
        ...
        $('#MediaFromDate').datepicker({
            dateFormat: "yy-mm-dd",
            changeMonth: true,
            changeYear: true,

            onSelect: function (selectedDate) {
                $('#MediaToDate').datepicker("option", {
                    minDate: new Date(selectedDate),

                });
            },
        });
        $('#MediaToDate').datepicker({
            dateFormat: "yy-mm-dd",
            //dateFormat: "dd-mm-yy",
            changeMonth: true,
            changeYear: true,
            ...
            onClose: function (selectedDate) {
                $("#MediaFromDate").datepicker("option", "maxDate", selectedDate);
            }
        ...
        $(".my_status").on('click', function () {
            ...
            if (status_current == 1) {
                var heading = "Media will be inactivated";
                var title_resp = "Inactivated";
            } else {
                var heading = "Media will be activated";
            ...
            swal({
                ...
                closeOnConfirm: false,
                    ...
                    function () {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo $this->Html->url(array('plugin' => 'media', 'controller' => 'medias', 'action' => 'status_ajax')); ?>',
                            data: 'id=' + status_id,
                            dataType: 'json',
                    ...
                    <div class="row">
                        <div class="col-md-12 space20">
                            <div class="pull-left1 driver_index1">
                                ...
                                <?php
                                echo $this->Form->select('Media.media_type_id', $cat_list, array('value' => @$media_type_id, 'class' => 'textbox form-control input-sm', 'empty' => "Select Type", 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Media.title', array('placeholder' => 'Title', 'value' => @$title, 'class' => 'form-control input-sm')) . "&nbsp;&nbsp;";
                                echo $this->Form->select('Media.is_active', array("1" => "Active", "0" => "Inactive"), array('value' => @$is_active, 'empty' => __('Media Status', true), 'class' => 'form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Media.from_date', array('placeholder' => __('From Date', true), 'autocomplete' => 'off', 'value' => @$from_date, 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Media.to_date', array('placeholder' => __('To Date', true), 'autocomplete' => 'off', 'value' => @$to_date, 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                    ...
                                    if (!empty($records)) {
                                        ...
                                        <?php foreach ($records as $list) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    if ($list[$model]['media_type_id'] == 1) {

                                                        $url = $list[$model]['media_url'];
                                                        ...
                                                        $file_name = $list[$model]['media_url'];

                                                        $images = $this->Html->image(MEDIA_IMAGE_HTTP_PATH . $file_name, array('width' => "200px", 'height' => '150px'));
                                                        ?>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown" style='float:left'>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                            ...
                                                            <li>
                                                                <?php
                                                                echo $this->Html->link('Edit', array('plugin' => 'media', 'controller' => 'medias', 'action' => 'edit', '?' => array('id' => $list['Media']['id'])), array('class' => '', 'tooltip-placement' => 'top', 'tooltip' => 'Edit', 'escape' => false));
                                                                ?>							
                                                            </li>
