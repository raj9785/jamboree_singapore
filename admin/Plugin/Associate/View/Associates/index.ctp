...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#add_new_user").click(function () {
            window.location.href = '<?php echo $this->Html->url(array('plugin' => 'associate', 'controller' => 'associates', 'action' => 'add')); ?>';
        });
        $("#single_1").fancybox({
            helpers: {
                title: {
        ...
        $('#AssociateFromDate').datepicker({
            dateFormat: "yy-mm-dd",
            changeMonth: true,
            changeYear: true,

            onSelect: function (selectedDate) {
                $('#AssociateToDate').datepicker("option", {
                    minDate: new Date(selectedDate),

                });

                //$("#AssociateToDate").datepicker("option", "minDate", selectedDate);
            },
        });
        $('#AssociateToDate').datepicker({
            dateFormat: "yy-mm-dd",
            //dateFormat: "dd-mm-yy",
            changeMonth: true,
            changeYear: true,
            ...
            onClose: function (selectedDate) {
                $("#AssociateFromDate").datepicker("option", "maxDate", selectedDate);
            }
        ...
        $(".my_status").on('click', function () {
            ...
            if (status_current == 1) {
                var heading = "Associate will be inactivated";
                var title_resp = "Inactivated";
            } else {
                var heading = "Associate will be activated";
            ...
            swal({
                ...
                closeOnConfirm: false,
                    ...
                    function () {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo $this->Html->url(array('plugin' => 'associate', 'controller' => 'associates', 'action' => 'status_ajax')); ?>',
                            data: 'id=' + status_id,
                            dataType: 'json',
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 text-align-right">
                            <button class="btn btn-green add-row" id='add_new_user'>
                                <i class="fa fa-plus"></i>&nbsp;Add New Associate
                            </button>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-full-width">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hidden-xs">Image Alt Tag</th>
                                        ...
                                        <?php foreach ($records as $list) { ?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    ...
                                                    $images = $this->Html->image(ASSOCIATES_IMAGE_HTTP_PATH . $file_name,array("width"=>"100px"));
                                                    ?>
                                                    <a id="single_1" href="<?php echo ASSOCIATES_IMAGE_HTTP_PATH . $file_name; ?>">
                                                        <?php echo $images; ?>
                                                    </a>

                                                </td>
                                                <td><?php
                                                   echo $list[$model]['alt_tag'];
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown" style='float:left'>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                            ...
                                                            <li>
                                                                <?php
                                                                echo $this->Html->link('Edit', array('plugin' => 'associate', 'controller' => 'associates', 'action' => 'edit', '?' => array('id' => $list['Associate']['id'])), array('class' => '', 'tooltip-placement' => 'top', 'tooltip' => 'Edit', 'escape' => false));
                                                                ?>							
                                                            </li>
