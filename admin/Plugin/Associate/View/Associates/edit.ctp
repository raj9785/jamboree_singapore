...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#cancel_button").click(function () {
            window.location.href = '<?php echo $this->Html->url(array('plugin' => 'associate', 'controller' => 'associates', 'action' => 'index')); ?>';
        });
        $("#single_1").fancybox({
            helpers: {
                title: {
...
<?php
echo $this->Html->script(array('associates'));
?>
<div id="app">
    <!-- sidebar -->
            ...
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        ...
                        <div class="col-sm-2 text-align-right">
                            <?php echo $this->Html->link("<i class=\"icon-arrow-left icon-white\"></i>" . __('Back to List', true) . "", array('plugin' => 'associate', 'controller' => 'associates', "action" => "index"), array("class" => "btn btn-green add-row", "escape" => false)); ?>
                        </div>
                ...
                <div class="container-fluid container-fullw bg-white">
                    ...
                    <div class="row">
                        ...
                        <?php
                        echo $this->Form->create('Associate', array(array('method' => 'post', 'class' => 'form', 'role' => 'form'), 'enctype' => 'multipart/form-data'));
                        ?>
                        <?php echo $this->Form->input('Associate.id', array('type' => 'hidden')); ?>
                            ...
                            <div class="col-md-12"> 
                                <div class="col-md-6"> 
                                    <div class="form-group">
                                        ...
                                        <?php
                                        $file_name = $users_data["Associate"]['image'];
                                        if (is_file(ASSOCIATES_IMAGE_PATH . $file_name)) {
                                            $images = $this->Html->image(ASSOCIATES_IMAGE_HTTP_PATH . $file_name);
                                            ?>
