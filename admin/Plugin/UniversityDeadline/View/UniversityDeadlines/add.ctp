...
<?php
echo $this->Html->script(array('add_university_deadline'));
?>
<div id="app">
    <!-- sidebar -->
                            ...
                            <div class="col-md-6"> 
                                <div class="col-md-12"> 
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->select('deadline_category_id', $pos_list, array('id' => 'deadline_category_id', "class" => "form-control", 'empty' => "Select Course",)); ?>
