...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#add_new_user").click(function () {
            window.location.href = '<?php echo $this->Html->url(array('plugin' => 'score', 'controller' => 'scores', 'action' => 'add')); ?>';
        });
        $("#single_1").fancybox({
            helpers: {
                title: {
        ...
        $('#ScoreFromDate').datepicker({
            dateFormat: "yy-mm-dd",
            changeMonth: true,
            changeYear: true,

            onSelect: function (selectedDate) {
                $('#ScoreToDate').datepicker("option", {
                    minDate: new Date(selectedDate),

                });
            },
        });
        $('#ScoreToDate').datepicker({
            dateFormat: "yy-mm-dd",
            //dateFormat: "dd-mm-yy",
            changeMonth: true,
            changeYear: true,
            ...
            onClose: function (selectedDate) {
                $("#ScoreFromDate").datepicker("option", "maxDate", selectedDate);
            }
        ...
        $(".my_status").on('click', function () {
            ...
            if (status_current == 1) {
                var heading = "Score will be inactivated";
                var title_resp = "Inactivated";
            } else {
                var heading = "Score will be activated";
            ...
            swal({
                ...
                closeOnConfirm: false,
                    ...
                    function () {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo $this->Html->url(array('plugin' => 'score', 'controller' => 'scores', 'action' => 'status_ajax')); ?>',
                            data: 'id=' + status_id,
                            dataType: 'json',
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 text-align-right">
                            <button class="btn btn-green add-row" id='add_new_user'>
                                <i class="fa fa-plus"></i>&nbsp;Add New Student Score
                            </button>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 space20">
                            <div class="pull-left1 driver_index1">
                                ...
                                <?php
                                echo $this->Form->select('Score.course_id', $cat_list, array('value' => @$course_id, 'class' => 'textbox form-control input-sm', 'empty' => "Select Course", 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Score.name', array('placeholder' => 'Student Name', 'value' => @$name, 'class' => 'form-control input-sm')) . "&nbsp;&nbsp;";
                                echo $this->Form->select('Score.is_active', array("1" => "Active", "0" => "Inactive"), array('value' => @$is_active, 'empty' => __('Select Status', true), 'class' => 'form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Score.from_date', array('placeholder' => __('From Date', true), 'value' => @$from_date, 'autocomplete' => 'off', 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Score.to_date', array('placeholder' => __('To Date', true), 'value' => @$to_date, 'autocomplete' => 'off', 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                    ...
                                    if (!empty($records)) {
                                        ...
                                        <?php foreach ($records as $list) { ?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    echo $list[$model]['marks'];
                                                    ?>
                                                </td>
                                                <td><?php
                                                    echo $list[$model]['pass_year'];
                                                    ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown" style='float:left'>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                            ...
                                                            <li>
                                                                <?php
                                                                echo $this->Html->link('Edit', array('plugin' => 'score', 'controller' => 'scores', 'action' => 'edit', '?' => array('id' => $list['Score']['id'])), array('class' => '', 'tooltip-placement' => 'top', 'tooltip' => 'Edit', 'escape' => false));
                                                                ?>							
                                                            </li>
