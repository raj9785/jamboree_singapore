...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#add_new_user").click(function () {
            window.location.href = '<?php echo $this->Html->url(array('plugin' => 'faq', 'controller' => 'faqs', 'action' => 'add')); ?>';
        });


        $('#FaqFromDate').datepicker({
            dateFormat: "yy-mm-dd",
            changeMonth: true,
            changeYear: true,

            onSelect: function (selectedDate) {
                $('#FaqToDate').datepicker("option", {
                    minDate: new Date(selectedDate),

                });
            },
        });
        $('#FaqToDate').datepicker({
            dateFormat: "yy-mm-dd",
            //dateFormat: "dd-mm-yy",
            changeMonth: true,
            changeYear: true,
            ...
            onClose: function (selectedDate) {
                $("#FaqFromDate").datepicker("option", "maxDate", selectedDate);
            }
            ...
            swal({
                ...
                closeOnConfirm: false,
                    ...
                    function () {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo $this->Html->url(array('plugin' => 'faq', 'controller' => 'faqs', 'action' => 'status_ajax')); ?>',
                            data: 'id=' + status_id,
                            dataType: 'json',
                    ...
                    <div class="row">
                        <div class="col-md-12 space20">
                            <div class="pull-left1 driver_index1">
                                ...
                                <?php
                                echo $this->Form->select('Faq.menu_slug', $pos_list, array('value' => @$menu_slug, 'class' => 'textbox form-control input-sm', 'empty' => "Select Page", 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                //echo $this->Form->text('Faq.script_title', array('placeholder' => 'Script Name', 'value' => @$script_title, 'class' => 'form-control input-sm')) . "&nbsp;&nbsp;";
                                echo $this->Form->select('Faq.is_active', array("1" => "Active", "0" => "Inactive"), array('value' => @$is_active, 'empty' => __('Select Status', true), 'class' => 'form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Faq.from_date', array('placeholder' => __('From Date', true), 'value' => @$from_date, 'autocomplete' => 'off', 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Faq.to_date', array('placeholder' => __('To Date', true), 'value' => @$to_date, 'autocomplete' => 'off', 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                            ...
                            <table class="table table-striped table-bordered table-full-width">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hidden-xs" style="width:20%">Question</th>
                                        <th class="hidden-xs" style="width:40%">Answer</th>
                                    ...
                                    if (!empty($records)) {
                                        ...
                                        <?php foreach ($records as $list) { ?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    echo $list[$model]['question'];
                                                    ?>
                                                </td>
                                                <td><?php
                                                    echo $list[$model]['answer'];
                                                    ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown" style='float:left'>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                            ...
                                                            <li>
                                                                <?php
                                                                echo $this->Html->link('Edit', array('plugin' => 'faq', 'controller' => 'faqs', 'action' => 'edit', '?' => array('id' => $list['Faq']['id'])), array('class' => '', 'tooltip-placement' => 'top', 'tooltip' => 'Edit', 'escape' => false));
                                                                ?>							
                                                            </li>
