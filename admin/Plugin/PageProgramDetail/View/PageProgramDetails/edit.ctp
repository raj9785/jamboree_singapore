            ...
            <div class="wrap-content container" id="container">
                ...
                <div class="container-fluid container-fullw bg-white">
                    ...
                    <div class="row">
                        ...
                        ?>
                        <?php echo $this->Form->input('PageProgramDetail.id', array('type' => 'hidden')); ?>
                        <div class="row">
                            <div class="col-md-12 " > 
                                <div class="col-md-6"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        $file_name = $users_data["PageProgramDetail"]['image'];
                                        if (is_file(PAGE_ICON_PATH . $file_name)) {
                                            $images = $this->Html->image(PAGE_ICON_HTTP_PATH . $file_name);
                                            ?>
                            ...
                            <div class="col-md-12"> 
                                ...
                                <div class="col-md-4">
                                    <?php echo $this->Form->button('Update', array('class' => 'btn btn-primary btn-wide', 'type' => 'submit', 'id' => 'cancel_button_edit')) ?>
