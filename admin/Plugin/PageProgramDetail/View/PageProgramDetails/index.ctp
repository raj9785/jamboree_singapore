...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#add_new_user").click(function () {
            window.location.href = '<?php echo $this->Html->url(array('plugin' => 'page_program_detail', 'controller' => 'page_program_details', 'action' => 'add', $page_id)); ?>';
        });
...
//            closeClick: false,
        ...
        $(".my_status").on('click', function () {
            ...
            if (status_current == 1) {
                var heading = "PageProgramDetail will be inactivated";
                var title_resp = "Inactivated";
            } else {
                var heading = "PageProgramDetail will be activated";
            ...
            swal({
                ...
                closeOnConfirm: false,
                    ...
                    function () {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo $this->Html->url(array('plugin' => 'page_program_detail', 'controller' => 'page_program_details', 'action' => 'status_ajax')); ?>',
                            data: 'id=' + status_id,
                            dataType: 'json',
        ...
        <div class="main-content" >
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-9">
                         ...
                         <div class="col-sm-1">
                            <?php echo $this->Html->link("<i class=\"icon-arrow-left icon-white\"></i>" . __('Back to List', true) . "", array('plugin' => false, 'controller' => 'pages', "action" => "index"), array("class" => "btn btn-green add-row", "escape" => false)); ?>
                        </div>
                        <div class="col-sm-2">
                            <button class="btn btn-green add-row" id='add_new_user'>
                                <i class="fa fa-plus"></i>&nbsp;Add New Program Detail
                            </button>
                        </div>
                ...
                <div class="container-fluid container-fullw bg-white">
                    <?php
                    echo $this->Form->create('PageProgramDetail', array('type' => 'get', 'class' => 'form-inline', 'inputDefaults' => array('label' => false, 'div' => false)));
                    ?>
                    <div class="row">
                            ...
                            <table class="table table-striped table-bordered table-full-width">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hidden-xs">Icon Alt Text</th>
                                        ...
                                        <?php foreach ($records as $list) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($file_name) {
                                                        $images = $this->Html->image(PAGE_ICON_HTTP_PATH . $file_name, array('alt' => $file_name, 'title' => $list['PageProgramDetail']['alt_text']));
                                                        ?>
                                                        <a id="single_1" href="<?php echo PAGE_ICON_HTTP_PATH . $file_name; ?>"
                                                ...
                                                <td><?php
                                                    echo $list['PageProgramDetail']['alt_text'];
                                                    ?>
                                                </td>
                                                <td><?php
                                                    echo $list['PageProgramDetail']['heading_text'];
                                                    ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown" style='float:left'>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                            ...
                                                            <li>
                                                                <?php
                                                                echo $this->Html->link('Edit', array('plugin' => 'page_program_detail', 'controller' => 'page_program_details', 'action' => 'edit', '?' => array('id' => $list['PageProgramDetail']['id'], 'page_id' => $page_id)), array('class' => '', 'tooltip-placement' => 'top', 'tooltip' => 'Edit', 'escape' => false));
                                                                ?>							
                                                            </li>
