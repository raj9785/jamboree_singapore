...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#add_new_user").click(function () {
            window.location.href = '<?php echo $this->Html->url(array('plugin' => 'social', 'controller' => 'socials', 'action' => 'add')); ?>';
        });
        $("#single_1").fancybox({
            helpers: {
                title: {
        ...
        $(".my_status").on('click', function () {
            ...
            if (status_current == 1) {
                var heading = "Social will be inactivated";
                var title_resp = "Inactivated";
            } else {
                var heading = "Social will be activated";
            ...
            swal({
                ...
                closeOnConfirm: false,
                    ...
                    function () {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo $this->Html->url(array('plugin' => 'social', 'controller' => 'socials', 'action' => 'status_ajax')); ?>',
                            data: 'id=' + status_id,
                            dataType: 'json',
                                        ...
                                        <?php foreach ($records as $list) { ?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    ...
                                                    $images = $this->Html->image(SOCIALS_IMAGE_HTTP_PATH . $file_name,array("width=55px"));
                                                    ?>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown" style='float:left'>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                            ...
                                                            <li>
                                                                <?php
                                                                echo $this->Html->link('Edit', array('plugin' => 'social', 'controller' => 'socials', 'action' => 'edit', '?' => array('id' => $list['Social']['id'])), array('class' => '', 'tooltip-placement' => 'top', 'tooltip' => 'Edit', 'escape' => false));
                                                                ?>							
                                                            </li>
