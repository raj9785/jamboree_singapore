...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        $('#CareerFromDate').datepicker({
            dateFormat: "yy-mm-dd",
            changeMonth: true,
            changeYear: true,

            onSelect: function (selectedDate) {
                $('#CareerToDate').datepicker("option", {
                    minDate: new Date(selectedDate),

                });

                //$("#CareerToDate").datepicker("option", "minDate", selectedDate);
            },
        });
        $('#CareerToDate').datepicker({
            dateFormat: "yy-mm-dd",
            //dateFormat: "dd-mm-yy",
            changeMonth: true,
            changeYear: true,
            ...
            onClose: function (selectedDate) {
                $("#CareerFromDate").datepicker("option", "maxDate", selectedDate);
            }
        ...
        $(".my_status").on('click', function () {
            ...
            if (status_current == 1) {
                var heading = "Career will be inactivated";
                var title_resp = "Inactivated";
            } else {
                var heading = "Career will be activated";
            ...
            swal({
                ...
                closeOnConfirm: false,
                    ...
                    function () {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo $this->Html->url(array('plugin' => 'career', 'controller' => 'careers', 'action' => 'status_ajax')); ?>',
                            data: 'id=' + status_id,
                            dataType: 'json',
                    ...
                    <div class="row">
                        <div class="col-md-12 space20">
                            <div class="pull-left1 driver_index1">
                                ...
                                <?php
                                echo $this->Form->select('Career.career_category_id', $cat_list, array('value' => @$career_category_id, 'class' => 'textbox form-control input-sm', 'empty' => "Select Area", 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Career.title', array('placeholder' => 'Title', 'value' => @$heading, 'class' => 'form-control input-sm')) . "&nbsp;&nbsp;";
                                echo $this->Form->select('Career.is_active', array("1" => "Active", "0" => "Inactive"), array('value' => @$is_active, 'empty' => __('Career Status', true), 'class' => 'form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Career.from_date', array('placeholder' => __('From Date', true), 'value' => @$from_date, 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                echo $this->Form->text('Career.to_date', array('placeholder' => __('To Date', true), 'value' => @$to_date, 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                                    ...
                                    if (!empty($records)) {
                                        ...
                                        <?php foreach ($records as $list) { ?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    echo $list['Career']['title'];
                                                    ?>
                                                </td>
                                                <td><?php
                                                    echo $list['Career']['location'];
                                                    ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown" style='float:left'>
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                            ...
                                                            <li>
                                                                <?php
                                                                echo $this->Html->link('Edit', array('plugin' => 'career', 'controller' => 'careers', 'action' => 'edit', '?' => array('id' => $list['Career']['id'])), array('class' => '', 'tooltip-placement' => 'top', 'tooltip' => 'Edit', 'escape' => false));
                                                                ?>							
                                                            </li>
