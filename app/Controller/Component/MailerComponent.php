...
class MailerComponent extends Component
{
   ...
   */
    var $from         = 'noreply@supercabz.com';
    var $fromName     = "supercabz";
    var $smtpUserName = 'developer@brsoftech.com';  // SMTP username
    var $smtpPassword = 'brsoftech@123'; // SMTP password
 ...
 function initialize(Controller $controller) {
     ...
     */
      ob_start();
      $temp_layout = $this->controller->layout;
      $this->controller->layout = 'default';  //  HTML wrapper for my html email in /app/views/layouts
